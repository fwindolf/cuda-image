...
template <typename T, typename TO, typename std::enable_if<has_4_channels<TO>::value, TO >::type* = nullptr >
...
template <typename T, typename TO, typename std::enable_if<has_3_channels<TO>::value, TO >::type* = nullptr >
__global__ void g_GrayToColor(DevPtr<TO> output, const DevPtr<T> input)
{
    dim3 pos = getPos(blockIdx, blockDim, threadIdx);
...
template <typename T, typename TO, typename std::enable_if<has_4_channels<T>::value, T >::type* = nullptr >
...
template <typename T, typename TO, typename std::enable_if<has_3_channels<T>::value, T >::type* = nullptr >
__global__ void g_ColorToGray(DevPtr<TO> output, const DevPtr<T> input)
{
    dim3 pos = getPos(blockIdx, blockDim, threadIdx);
...
template <typename T, typename TO, typename std::enable_if<has_3_channels<T>::value && has_4_channels<TO>::value, T >::type* = nullptr >
...
template <typename T, typename TO, typename std::enable_if<has_4_channels<T>::value && has_3_channels<TO>::value, T >::type* = nullptr >
__global__ void g_ColorToColor(DevPtr<TO> output, const DevPtr<T> input)
{
    dim3 pos = getPos(blockIdx, blockDim, threadIdx);
