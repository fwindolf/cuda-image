 ...
 */
template <> class TypedVisualizer<DEPTH_TYPE> : public VisualizerBase
{
public:
...
inline TypedVisualizer<DEPTH_TYPE>::TypedVisualizer(
...
inline bool TypedVisualizer<DEPTH_TYPE>::bindToTexture_() { return true; }
