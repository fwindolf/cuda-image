 ...
 */
template <typename T>
__device__ T d_between(const T& v0, const T& v1, const int p0, const int p1, const float p)
{
    if (v0 == v1)
        return v0;
 ...
 */
template <typename T>
__device__ T d_interpolate_linear(const T& v0, const T& v1, const uchar m0, const uchar m1, const int p0, const int p1, const float p)
{
 ...
 */
template <typename T>
__device__ T d_interpolate_linear_masked(const T& v0, const T& v1, const uchar m0, const uchar m1, const int p0, const int p1, const float p)
{
    if(!m0 && !m1)
        return make<T>(0.f);
    else if(!m0)
 ...
 */
template <typename T>
__device__ T d_interpolate_linear_valid(const T& v0, const T& v1, const uchar m0, const uchar m1, const int p0, const int p1, const float p)
{
    assert(p1 > p0);
 ...
 */
template <typename T>
__device__ T d_interpolate_linear_valid_masked(const T& v0, const T& v1, const uchar m0, const uchar m1, const int p0, const int p1, const float p)
{
    assert(p1 > p0);
 ...
 */
template <typename T>
__device__ T d_interpolate_linear_nonzero_masked(const T& v0, const T& v1, const uchar m0, const uchar m1, const int p0, const int p1, const float p)
{
    assert(p1 > p0);
        
    // Both or one of the pixels is valid
    if (isvalid(v0) && v0 > make<T>(0.f) && m0 && isvalid(v1) && m1 && v1 > make<T>(0.f))
        return d_between(v0, v1, p0, p1, p); 
 ...
 */
template <typename T>
__device__ T d_interpolate_nearest(const T& v0, const T& v1, const uchar m0, const uchar m1, const int p0, const int p1, const float p)
{
    assert(p1 > p0);
 ...
 */
template <typename T>
__device__ T d_interpolate_nearest_valid(const T& v0, const T& v1, const uchar m0, const uchar m1, const int p0, const int p1, const float p)
{
    assert(p1 > p0);
 ...
 */
template <typename T>
__device__ T d_interpolate_nearest_masked(const T& v0, const T& v1, const uchar m0, const uchar m1, const int p0, const int p1, const float p)
{
    assert(p1 > p0);
 ...
 */
template <typename T>
__device__ T d_interpolate_nearest_valid_masked(const T& v0, const T& v1, const uchar m0, const uchar m1, const int p0, const int p1, const float p)
{
    assert(p1 > p0);
