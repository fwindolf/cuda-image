...
#define FOR_EACH_TYPE(func, ...)                                              \
    func(float, __VA_ARGS__) func(float1, __VA_ARGS__)                        \
        func(float2, __VA_ARGS__) func(float3, __VA_ARGS__)                   \
            func(float4, __VA_ARGS__) func(uchar, __VA_ARGS__)                \
                func(uchar1, __VA_ARGS__) func(uchar2, __VA_ARGS__)           \
                    func(uchar3, __VA_ARGS__) func(uchar4, __VA_ARGS__)       \
                        func(int, __VA_ARGS__) func(int1, __VA_ARGS__)        \
                            func(int2, __VA_ARGS__) func(int3, __VA_ARGS__)   \
                                func(int4, __VA_ARGS__)

#define FOR_EACH_FLOAT_TYPE(func, ...)                                        \
    func(float, __VA_ARGS__) func(float1, __VA_ARGS__) func(float2,           \
        __VA_ARGS__) func(float3, __VA_ARGS__) func(float4, __VA_ARGS__)

#define FOR_EACH_UCHAR_TYPE(func, ...)                                        \
    func(uchar, __VA_ARGS__) func(uchar1, __VA_ARGS__) func(uchar2,           \
        __VA_ARGS__) func(uchar3, __VA_ARGS__) func(uchar4, __VA_ARGS__)

#define FOR_EACH_INT_TYPE(func, ...)                                          \
    func(int, __VA_ARGS__) func(int1, __VA_ARGS__) func(int2, __VA_ARGS__)    \
        func(int3, __VA_ARGS__) func(int4, __VA_ARGS__)

#define FOR_EACH_0CHANNEL_TYPE(func, ...)                                     \
    func(float, __VA_ARGS__) func(uchar, __VA_ARGS__) func(int, __VA_ARGS__)

#define FOR_EACH_1CHANNEL_TYPE(func, ...)                                     \
    func(float1, __VA_ARGS__) func(uchar1, __VA_ARGS__) func(int1, __VA_ARGS__)

#define FOR_EACH_2CHANNEL_TYPE(func, ...)                                     \
    func(float2, __VA_ARGS__) func(uchar2, __VA_ARGS__) func(int2, __VA_ARGS__)

#define FOR_EACH_3CHANNEL_TYPE(func, ...)                                     \
    func(float3, __VA_ARGS__) func(uchar3, __VA_ARGS__) func(int3, __VA_ARGS__)

#define FOR_EACH_4CHANNEL_TYPE(func, ...)                                     \
    func(float4, __VA_ARGS__) func(uchar4, __VA_ARGS__) func(int4, __VA_ARGS__)
...
template <typename T> struct is_extended_vector_type : std::false_type
{
};
...
template <typename T> struct is_uchar_type : std::false_type
{
};
...
template <typename T> struct has_4_channels : std::false_type
{
};
...
template <typename T> struct has_3_channels : std::false_type
{
};
...
template <typename T> struct has_2_channels : std::false_type
{
};
...
template <typename T> struct has_1_channels : std::false_type
{
};
...
template <typename T> struct has_0_channels : std::false_type
{
};
...
template <typename T, typename TO> bool is_same_base()
{
    return (is_float<T>() && is_float<TO>())
        || (is_uchar<T>() && is_uchar<TO>()) || (is_int<T>() && is_int<TO>());
}
 ...
 */
template <typename T,
    typename std::enable_if<is_vector_type<T>::value
            && has_1_channels<T>::value,
        T>::type* = nullptr>
