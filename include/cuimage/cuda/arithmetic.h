 ...
 */
template <typename T>
__host__ __device__ float sum(const T v);
 ...
 */
template <typename T>
__host__ __device__ T min(const T l, const T r);
 ...
 */
template <typename T>
__host__ __device__ T max(const T l, const T r);

/**
 * @brief Get the absolute value per member
 */
template <typename T>
__host__ __device__ T abs(const T& v);

/**
 * @brief Get the minimum channel of a multichannel v
 */
template <typename T>
__host__ __device__ float min(const T& v);

/**
 * @brief Get the maximum channel of a multichannel v
 */
template <typename T>
__host__ __device__ float max(const T& v);
...
#endif
template <typename T>
__host__ __device__ bool isnan(const T& v);
...
#endif
template <typename T>
__host__ __device__ bool isinf(const T& v);
 ...
 */
template <typename T>
__host__ __device__ bool isvalid(const T& v);

/**
 * @brief Check if the value provided equals to zero
 */
template <typename T>
inline __host__ __device__ bool iszero(const T& v)
{
    return (v == make<T>(0.f));
}
 ...
 */
template <typename T>
inline __host__ __device__ float norm(const T v)
{
 ...
 */
template <typename T>
inline __host__ __device__ T normalize(const T v)
{
...
template <>
inline __host__ __device__ float make(const float v)
{
    return v;
}

template <>
inline __host__ __device__ float sum(const float v)
{
    return v;
}
...
template <>
inline __host__ __device__ float abs(const float& v)
{
    return (v > 0 ? v : -v);
}

template <>
inline __host__ __device__ bool isnan(const float& v)
{
    return (v != v);
}

template <>
inline __host__ __device__ bool isinf(const float & v)
{
    return (v == INFINITY || v == -INFINITY);
}

template <>
inline __host__ __device__ bool isvalid(const float& v)
{
    return (!isnan(v) && !isinf(v));
}

template <>
inline __host__ __device__ bool iszero(const float& v)
{
    return (v == 0);
}
...
template <>
inline __host__ __device__ int make(const float v)
{
    return static_cast<int>(v);
}

template <>
inline __host__ __device__ float sum(const int v)
{
    return static_cast<float>(v);
}

template <>
inline __host__ __device__ int min(const int l, const int r)
{
    return (l < r ? l : r);
}

template <>
inline __host__ __device__ int max(const int l, const int r)
{
    return (l > r ? l : r);
}

template <>
inline __host__ __device__ float min(const int& v)
{
    return static_cast<float>(v);
}

template <>
inline __host__ __device__ float max(const int& v)
{
    return static_cast<float>(v);
}

template <>
inline __host__ __device__ int abs(const int& v)
{
    return (v > 0 ? v : -v);
}

template <>
inline __host__ __device__ bool isnan(const int& v)
{
    return false; // int cannot be NaN
}

template <>
inline __host__ __device__ bool isinf(const int& v)
{
    return (v == INT_MIN || v == INT_MAX); // if it is int_max or int_min
}

template <>
inline __host__ __device__ bool isvalid(const int& v)
{
    return (!isnan(v) && !isinf(v));
}

template <>
inline __host__ __device__ bool iszero(const int& v)
{
    return (v == 0);
}
...
template <>
inline __host__ __device__ uchar make(const float v)
{
    return static_cast<uchar>(v);
}

template <>
inline __host__ __device__ float sum(const uchar v)
{
    return static_cast<float>(v);
}
...
template <>
inline __host__ __device__ float min(const uchar& v)
{
    return static_cast<float>(v);
}

template <>
inline __host__ __device__ float max(const uchar& v)
{
    return static_cast<float>(v);
}

template <>
inline __host__ __device__ uchar abs(const uchar& v)
{
    return (v > 0 ? v : -v);
}

template <>
inline __host__ __device__ bool isnan(const uchar& v)
{
    return false; // uchar cannot be NaN
}

template <>
inline __host__ __device__ bool isinf(const uchar& v)
{
    return false; // uchar cannot be Inf
}

template <>
inline __host__ __device__ bool isvalid(const uchar& v)
{
    return (!isnan(v) && !isinf(v));
}

template <>
inline __host__ __device__ bool iszero(const uchar& v)
{
    return (v == 0);
}
...
template <>
inline __host__ __device__ uchar1 operator+(const uchar1& lhs, const uchar1& rhs)
{
...
template <>
inline __host__ __device__ float sum(const uchar1 v)
{
...
template <>
inline __host__ __device__ float min(const uchar1& v)
{
    return static_cast<float>(v.x);
}

template <>
inline __host__ __device__ float max(const uchar1& v)
{
    return static_cast<float>(v.x);
}

template <>
inline __host__ __device__ uchar1 abs(const uchar1& v)
{
    return make_uchar1(abs(v.x));
}

template <>
inline __host__ __device__ bool isnan(const uchar1& v)
{
    return isnan(v.x);
}

template <>
inline __host__ __device__ bool isinf(const uchar1& v)
{
    return isinf(v.x);
}

template <>
inline __host__ __device__ bool isvalid(const uchar1& v)
{
    return isvalid(v.x);
}
...
template <>
inline __host__ __device__ uchar2 make(const float v)
{
    return make_uchar2(static_cast<uchar>(v), static_cast<uchar>(v));
}

template <>
inline __host__ __device__ float sum(const uchar2 v)
{
...
template <>
inline __host__ __device__ float min(const uchar2& v)
{
    return static_cast<float>(min(v.x, v.y));
}

template <>
inline __host__ __device__ float max(const uchar2& v)
{
    return static_cast<float>(max(v.x, v.y));
}

template <>
inline __host__ __device__ uchar2 abs(const uchar2& v)
{
    return make_uchar2(abs(v.x), abs(v.y));
}

template <>
inline __host__ __device__ bool isnan(const uchar2& v)
{
    return (isnan(v.x) || isnan(v.y));
}

template <>
inline __host__ __device__ bool isinf(const uchar2& v)
{
    return (isinf(v.x) || isinf(v.y));
}

template <>
inline __host__ __device__ bool isvalid(const uchar2& v)
{
...
template <>
inline __host__ __device__ uchar3 operator+(const uchar3& lhs, const uchar3& rhs)
{
...
template <>
inline __host__ __device__ float sum(const uchar3 v)
{
...
template <>
inline __host__ __device__ float min(const uchar3& v)
{
    return static_cast<float>(min(min(v.x, v.y), v.z));
}

template <>
inline __host__ __device__ float max(const uchar3& v)
{
    return static_cast<float>(max(max(v.x, v.y), v.z));
}

template <>
inline __host__ __device__ uchar3 abs(const uchar3& v)
{
    return make_uchar3(abs(v.x), abs(v.y), abs(v.z));
}

template <>
inline __host__ __device__ bool isnan(const uchar3& v)
{
    return (isnan(v.x) || isnan(v.y) || isnan(v.z));
}

template <>
inline __host__ __device__ bool isinf(const uchar3& v)
{
    return (isinf(v.x) || isinf(v.y) || isinf(v.z));
}

template <>
inline __host__ __device__ bool isvalid(const uchar3& v)
{
...
template <>
inline __host__ __device__ uchar4 make(const float v)
{
    return make_uchar4(static_cast<uchar>(v), static_cast<uchar>(v), static_cast<uchar>(v), static_cast<uchar>(v));
}

template <>
inline __host__ __device__ float sum(const uchar4 v)
{
...
{
    return make_uchar4(min(l.x, r.x), min(l.y, r.y), min(l.z, r.z), min(l.w, r.w));
}

template <>
inline __host__ __device__ uchar4 max(const uchar4 l, const uchar4 r)
{
    return  make_uchar4(max(l.x, r.x), max(l.y, r.y), max(l.z, r.z), max(l.w, r.w));
}

template <>
inline __host__ __device__ float min(const uchar4& v)
{
    return static_cast<float>(min(min(min(v.x, v.y), v.z), v.w));
}

template <>
inline __host__ __device__ float max(const uchar4& v)
{
    return static_cast<float>(max(max(max(v.x, v.y), v.z), v.w));
}

template <>
inline __host__ __device__ uchar4 abs(const uchar4& v)
{
    return make_uchar4(abs(v.x), abs(v.y), abs(v.z), abs(v.w));
}

template <>
inline __host__ __device__ bool isnan(const uchar4& v)
{
    return (isnan(v.x) || isnan(v.y) || isnan(v.z) || isnan(v.w));
}

template <>
inline __host__ __device__ bool isinf(const uchar4& v)
{
    return (isinf(v.x) || isinf(v.y) || isinf(v.z) || isnan(v.w));
}

template <>
inline __host__ __device__ bool isvalid(const uchar4& v)
{
...
template <>
inline __host__ __device__ float1 operator+(const float1& lhs, const float1& rhs)
{
...
template <>
inline __host__ __device__ float1 make(const float v)
{
    return make_float1(v);
}

template <>
inline __host__ __device__ float sum(const float1 v)
{
    return v.x;
}
...
template <>
inline __host__ __device__ float min(const float1& v)
{
    return v.x;
}

template <>
inline __host__ __device__ float max(const float1& v)
{
    return v.x;
}

template <>
inline __host__ __device__ float1 abs(const float1& v)
{
    return make_float1(abs(v.x));
}

template <>
inline __host__ __device__ bool isnan(const float1& v)
{
    return (v.x != v.x);
}

template <>
inline __host__ __device__ bool isinf(const float1 & v)
{
    return (v.x == INFINITY || v.x == -INFINITY);
}

template <>
inline __host__ __device__ bool isvalid(const float1& v)
{
    return isvalid(v.x);
}
...
template <>
inline __host__ __device__ float2 make(const float v)
{
    return make_float2(v, v);
}

template <>
inline __host__ __device__ float sum(const float2 v)
{
    return v.x + v.y;
}
...
template <>
inline __host__ __device__ float min(const float2& v)
{
    return min(v.x, v.y);
}

template <>
inline __host__ __device__ float max(const float2& v)
{
    return max(v.x, v.y);
}

template <>
inline __host__ __device__ float2 abs(const float2& v)
{
    return make_float2(abs(v.x), abs(v.y));
}

template <>
inline __host__ __device__ bool isnan(const float2& v)
{
    return (isnan(v.x) || isnan(v.y));
}

template <>
inline __host__ __device__ bool isinf(const float2& v)
{
    return (isinf(v.x) || isinf(v.y));
}

template <>
inline __host__ __device__ bool isvalid(const float2& v)
{
    return (isvalid(v.x) && isvalid(v.y));
}
...
template <>
inline __host__ __device__ float3 operator+(const float3& lhs, const float3& rhs)
{
...
template <>
inline __host__ __device__ float3 make(const float v)
{
    return make_float3(v, v, v);
}

template <>
inline __host__ __device__ float sum(const float3 v)
{
    return v.x + v.y + v.z;
}
...
template <>
inline __host__ __device__ bool isnan(const float3& v)
{
    return (isnan(v.x) || isnan(v.y) || isnan(v.z));
}

template <>
inline __host__ __device__ bool isinf(const float3& v)
{
    return (isinf(v.x) || isinf(v.y) || isinf(v.z));
}

template <>
inline __host__ __device__ bool isvalid(const float3& v)
{
    return (isvalid(v.x) && isvalid(v.y) && isvalid(v.z));
}
...
template <>
inline __host__ __device__ float4 operator+(const float4& lhs, const float4& rhs)
{
...
template <>
inline __host__ __device__ float4 make(const float v)
{
    return make_float4(v, v, v, v);
}

template <>
inline __host__ __device__ float sum(const float4 v)
{
...
{
    return make_float4(min(l.x, r.x), min(l.y, r.y), min(l.z, r.z), min(l.w, r.w));
}

template <>
inline __host__ __device__ float4 max(const float4 l, const float4 r)
{
    return  make_float4(max(l.x, r.x), max(l.y, r.y), max(l.z, r.z), max(l.w, r.w));
}

template <>
inline __host__ __device__ float min(const float4& v)
{
    return min(min(min(v.x, v.y), v.z), v.w);
}

template <>
inline __host__ __device__ float max(const float4& v)
{
    return max(max(max(v.x, v.y), v.z), v.w);
}

template <>
inline __host__ __device__ float4 abs(const float4& v)
{
    return make_float4(abs(v.x), abs(v.y), abs(v.z), abs(v.w));
}

template <>
inline __host__ __device__ bool isnan(const float4& v)
{
    return (isnan(v.x) || isnan(v.y) || isnan(v.z) || isnan(v.w));
}

template <>
inline __host__ __device__ bool isinf(const float4& v)
{
    return (isinf(v.x) || isinf(v.y) || isinf(v.z) || isnan(v.w));
}

template <>
inline __host__ __device__ bool isvalid(const float4& v)
{
    return (isvalid(v.x) && isvalid(v.y) && isvalid(v.z) && isvalid(v.w));
}
...
template <>
inline __host__ __device__ float sum(const int1 v)
{
    return static_cast<float>(v.x);
}

template <>
inline __host__ __device__ int1 min(const int1 l, const int1 r)
{
    return (l.x < r.x ? l : r);
}

template <>
inline __host__ __device__ int1 max(const int1 l, const int1 r)
{
    return (l.x > r.x ? l : r);
}

template <>
inline __host__ __device__ float min(const int1& v)
{
    return static_cast<float>(v.x);
}

template <>
inline __host__ __device__ float max(const int1& v)
{
    return static_cast<float>(v.x);
}

template <>
inline __host__ __device__ int1 abs(const int1& v)
{
    return make_int1(abs(v.x));
}

template <>
inline __host__ __device__ bool isnan(const int1& v)
{
    return isnan(v.x);
}

template <>
inline __host__ __device__ bool isinf(const int1& v)
{
    return isinf(v.x);
}

template <>
inline __host__ __device__ bool isvalid(const int1& v)
{
    return isvalid(v.x);
}
...
template <>
inline __host__ __device__ int2 make(const float v)
{
    return make_int2(static_cast<int>(v), static_cast<int>(v));
}

template <>
inline __host__ __device__ float sum(const int2 v)
{
    return static_cast<float>(v.x + v.y);
}

template <>
inline __host__ __device__ int2 min(const int2 l, const int2 r)
{
    return make_int2(min(l.x, r.x), min(l.y, r.y));
}

template <>
inline __host__ __device__ int2 max(const int2 l, const int2 r)
{
    return  make_int2(max(l.x, r.x), max(l.y, r.y));
}

template <>
inline __host__ __device__ float min(const int2& v)
{
    return static_cast<float>(min(v.x, v.y));
}

template <>
inline __host__ __device__ float max(const int2& v)
{
    return static_cast<float>(max(v.x, v.y));
}
...
template <>
inline __host__ __device__ bool isnan(const int2& v)
{
    return (isnan(v.x) || isnan(v.y));
}

template <>
inline __host__ __device__ bool isinf(const int2& v)
{
    return (isinf(v.x) || isinf(v.y));
}

template <>
inline __host__ __device__ bool isvalid(const int2& v)
{
    return (isvalid(v.x) && isvalid(v.y));
}
...
template <>
inline __host__ __device__ float sum(const int3 v)
{
    return static_cast<float>(v.x + v.y + v.z);
}

template <>
inline __host__ __device__ int3 min(const int3 l, const int3 r)
{
    return make_int3(min(l.x, r.x), min(l.y, r.y), min(l.z, r.z));
}

template <>
inline __host__ __device__ int3 max(const int3 l, const int3 r)
{
    return  make_int3(max(l.x, r.x), max(l.y, r.y), max(l.z, r.z));
}

template <>
inline __host__ __device__ float min(const int3& v)
{
    return static_cast<float>(min(min(v.x, v.y), v.z));
}

template <>
inline __host__ __device__ float max(const int3& v)
{
    return static_cast<float>(max(max(v.x, v.y), v.z));
}
...
template <>
inline __host__ __device__ bool isnan(const int3& v)
{
    return (isnan(v.x) || isnan(v.y) || isnan(v.z));
}

template <>
inline __host__ __device__ bool isinf(const int3& v)
{
    return (isinf(v.x) || isinf(v.y) || isinf(v.z));
}

template <>
inline __host__ __device__ bool isvalid(const int3& v)
{
    return (isvalid(v.x) && isvalid(v.y) && isvalid(v.z));
}
...
{
    return make_int4(static_cast<int>(v), static_cast<int>(v), static_cast<int>(v), static_cast<int>(v));
}

template <>
inline __host__ __device__ float sum(const int4 v)
{
    return static_cast<float>(v.x + v.y + v.z + v.w);
}

template <>
inline __host__ __device__ int4 min(const int4 l, const int4 r)
{
    return make_int4(min(l.x, r.x), min(l.y, r.y), min(l.z, r.z), min(l.w, r.w));
}

template <>
inline __host__ __device__ int4 max(const int4 l, const int4 r)
{
    return  make_int4(max(l.x, r.x), max(l.y, r.y), max(l.z, r.z), max(l.w, r.w));
}

template <>
inline __host__ __device__ float min(const int4& v)
{
    return static_cast<float>(min(min(min(v.x, v.y), v.z), v.w));
}

template <>
inline __host__ __device__ float max(const int4& v)
{
    return static_cast<float>(max(max(max(v.x, v.y), v.z), v.w));
}
...
template <>
inline __host__ __device__ bool isnan(const int4& v)
{
    return (isnan(v.x) || isnan(v.y) || isnan(v.z) || isnan(v.w));
}

template <>
inline __host__ __device__ bool isinf(const int4& v)
{
    return (isinf(v.x) || isinf(v.y) || isinf(v.z) || isnan(v.w));
}

template <>
inline __host__ __device__ bool isvalid(const int4& v)
{
    return (isvalid(v.x) && isvalid(v.y) && isvalid(v.z) && isvalid(v.w));
}
